...
<h1 class="my-5 text-center">
    <div class="badge badge-warning text-wrap p-3">Accueil Admin</div>
</h1>

<?= $validate ?>
<h2 class="text-center my-5">
    <div class="badge badge-dark text-wrap p-3">Bonjour <?= $_SESSION['membre']['pseudo'] ?></div>
</h2>
