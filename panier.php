    ...
    <div class="col-lg-8">
      ...
      <div class="mb-3 shadow p-3 mb-5 bg-white rounded">
        <div class="pt-4 wish-list">
          ...
          <h5 class="mb-4">
            <div class="badge badge-dark text-wrap p-3">Détail de votre Panier</div>
          </h5>
          <!-- début de boucle -->
    ...
    <div class="col-lg-4">
      ...
      <div class="mb-3 shadow p-3 mb-5 bg-white rounded">
        <div class="pt-4">
          ...
          <h5 class="mb-5 text-right">
            <div class="badge badge-dark text-wrap p-3"> article(s) dans votre Panier</div>
          </h5>
      ...
      <div class="mb-3 shadow p-3 mb-5 bg-white rounded">
        <div class="pt-4">
          ...
          <h5 class="mb-5 text-center">
            <div class="badge badge-dark text-wrap p-3">Votre panier est actuellement vide.</div>
          </h5>
